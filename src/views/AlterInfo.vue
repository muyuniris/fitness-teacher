<template>
  <div class="info">
    ...
    <div class="line clearfix header">
      ...
      <div class="right">
        ...
        :after-read="afterRead">
          <div class="avtor">
            <img :src="this.$store.state.ip+this.img" alt="">
          </div>
        </van-uploader>
    ...
    <div class="line clearfix">
      ...
      <div >
        <van-field v-model="info" placeholder="请输入描述信息" type="textarea"/>
      </div>
    </div>
  ...
  methods:{
    ...
    alter(){
      if(!this.name){
        ...
        console.log("修改");
        this.axios.post('/teacher/alterTeacher',{
          id:id,
          name:this.name,
          birth:this.birth,
          sex:this.sex,
  ...
  created(){
    ...
    .then(res=>{
      ...
      if(res.data.code=="200"){
        ...
        this.sexIndex = data.t_sex;
        this.sex = data.t_sex?'女':'男';
        this.currentDate = data.t_birth;
        this.birth = data.t_birth?this.switchTimeFormat(data.t_birth):'';
        this.imgUrl = this.$store.state.ip+this.img;
        this.info = data.t_info;
        Toast.clear();
      }
    })
    .catch(err=>{
